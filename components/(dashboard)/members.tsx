...
function Avatar({ name }: { name?: string }) {
  // 1. Provide a safe fallback if the name is missing
  ...
  return (
    <div
      className={cn(
        ...
        getAvatarColor(safeName), // 2. Pass the safeName here too
      )}
    >
      {initials}
    </div>
...
// Ensure the component accepts workspaceId
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="relative mb-6">
          ...
          <Input
            ...
            className="h-12 pl-9 bg-white border-slate-200 text-sm focus-visible:ring-violet-500"
          />
        </div>
