    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button className="text-sm font-semibold text-white px-4 py-2 rounded-lg bg-linear-to-r from-indigo-500 to-violet-600 hover:opacity-90 transition-opacity shadow-md shadow-indigo-200">
            <Link
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-slate-100 px-4 py-4 space-y-3">
          ...
          {user ? (
            ...
            <Link href="/sign-in" className="block text-sm text-slate-700">
              Log in
            </Link>
          )}
          <button className="w-full mt-2 text-sm font-semibold text-white px-4 py-2.5 rounded-lg bg-linear-to-r from-indigo-500 to-violet-600">
            <Link
              href={user ? "/dashboard" : "/sign-in"}
