...
import { createProjectSchema } from "@/fetures/projects/schema";
...
export function CreateProjectModal({
  ...
  const form = useForm<CreateProjectFormValues>({
    ...
    defaultValues: { name: "", workspaceId, image: undefined },
  });
  ...
  return (
    <ResponsiveModal open={open} onOpenChange={handleClose} title="Create Project">
